...
$sql = "INSERT INTO employes(nom, prenom, email, telephone, adresse, date_debut_contrat, type_contrat, url_img) VALUES(:nom, :prenom, :email, :telephone, :adresse, :date_debut_contrat, :type_contrat, :url_img)";
